...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-kenya",
        destructive:
        ...
        kenya: "bg-gradient-kenya text-primary-foreground hover:opacity-90 shadow-kenya transform hover:scale-105 transition-bounce",
        education: "bg-education text-education-foreground hover:bg-education/90 shadow-education",
        success: "bg-success text-success-foreground hover:bg-success/90",
        hero: "bg-gradient-hero text-primary-foreground hover:opacity-90 shadow-kenya text-lg px-8 py-3",
      },
      size: {
